        ...
        <form action="#" method="POST" @submit.prevent="submitForm">
          <b-card show-footer>
            ...
            <div class="form-group">
              <label>Topic:</label>
              <!-- We only create questions from a topic, so no need to select here, just show Topic -->
            ...
            <div class="form-group px-0 col-md-5">
              ...
              <select
                ...
                @input="updateInput($event, 'difficulty')"
              >
...
export default {
  ...
  computed: {
    ...mapGetters("QuestionSingle", ["item", "loading", "topic"])
    // question_topic() {
  ...
  methods: {
    ...
    updateExplanation(value) {
      this.setValue({ key: "explanation", val: value });
    },
